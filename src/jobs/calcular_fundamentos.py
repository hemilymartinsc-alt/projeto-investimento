...
def main() -> int:
    ...
    try:
        ...
        mensagem = (
            ...
            f"periodo={resumo['primeira_data']}.."
        ...
        print(
            f"Demonstracoes lidas: "
            f"{lidos}"
        )

        print(
            f"Linhas atualizadas: "
            f"{gravados}"
        )

        print(
            f"Snapshots no banco: "
            f"{resumo['snapshots']}"
        )
